<template>
    <div class="app-stream-panel col-lg-6 col-mg-6">
        <!--<li>-->
        ...
        <!--        <a href="mailbox.html">-->
        <!--            <i class="fa fa-envelope"></i> <strong>Read More</strong>-->
        <!--        </a>-->
        <!--    </div>-->
        <!--</li>-->
...
<script>
    import StreamGroupLatest from './StreamGroupLatest.vue';

    export default {
        components: {
            'app-stream-group-latest': StreamGroupLatest 
        },
        data() {
            return {
                streamMessages: []
