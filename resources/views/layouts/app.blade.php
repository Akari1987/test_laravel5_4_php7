...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link href="{{ asset('css/inspinia/plugins/summernote/summernote-bs3.css') }}" rel="stylesheet">
    ...
    <body>
        ...
        <!--<script src="{{ asset('js/inspinia/bootstrap.js') }}"></script>-->
    ...
    <!--
        ...
        <script src="{{ asset('js/plugins/summernote/forsummernotetoolbar.js') }}"></script>
        <script src="{{ asset('js/inspinia.js') }}"></script>
        <script src="{{ asset('js/plugins/pace/pace.min.js') }}"></script>
        
        <!-- iCheck -->
        <script src="{{ asset('js/plugins/iCheck/icheck.min.js') }}"></script>
        <script src="{{ asset('js/plugins/summernote2/summernote.js') }}"></script>
